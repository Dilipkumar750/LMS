...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      className={`sticky bg-blue-700 top-0 before:absolute before:inset-0 before:backdrop-blur-md   dark:max-lg:before:bg-gray-800/90 before:-z-10 z-30 ${variant === 'v2' || variant === 'v3'
